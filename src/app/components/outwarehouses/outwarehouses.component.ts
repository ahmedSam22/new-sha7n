...
@Component({
  selector: 'app-outwarehouses',
  templateUrl: './outwarehouses.component.html',
  styleUrls: ['./outwarehouses.component.css']
})
export class OutwarehousesComponent implements OnInit {
  thisLang:any;
